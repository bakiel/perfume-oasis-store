...
async function applyStrategicPromotions() {
  ...
  const promotions = {
    // Premium Brand Flash Sale (High-ticket items)
    premiumFlash: {
    ...
    // Best Sellers (Popular mid-range)
    bestSellers: {
...
applyStrategicPromotions().catch(console.error)